...
//
//     final rentalBooking = rentalBookingFromJson(jsonString);

import 'dart:convert';

RentalBooking rentalBookingFromJson(String str) => RentalBooking.fromJson(json.decode(str));

String rentalBookingToJson(RentalBooking data) => json.encode(data.toJson());

class RentalBooking {
  RentalBooking({
    this.rentalBookingdatum,
  });

  List<RentalBookingdatum>? rentalBookingdatum;

  factory RentalBooking.fromJson(Map<String, dynamic> json) => RentalBooking(
    rentalBookingdatum: List<RentalBookingdatum>.from(json["RentalBookingdatum"].map((x) => RentalBookingdatum.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "RentalBookingdatum": List<dynamic>.from(rentalBookingdatum!.map((x) => x.toJson())),
  };
}

class RentalBookingdatum {
  RentalBookingdatum({
    this.id,
    this.userId,
    this.productOwnerId,
  ...
  DateTime? returnedAt;
  String? returned;
  String? returnConfirmed;
  DateTime? createdAt;
  Owner? rentar;
  Owner? owner;
  Product? product;

  factory RentalBookingdatum.fromJson(Map<String, dynamic> json) => RentalBookingdatum(
    ...
    returnedAt: json["returned_at"] == null ? null : DateTime.parse(json["returned_at"]),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "returned_at": returnedAt == null ? null : returnedAt?.toIso8601String(),
    "returned": returned,
