...
//
//     final sellBooking = sellBookingFromJson(jsonString);

import 'dart:convert';

SellBooking sellBookingFromJson(String str) => SellBooking.fromJson(json.decode(str));

String sellBookingToJson(SellBooking data) => json.encode(data.toJson());
...
class SellBooking {
  ...
  factory SellBooking.fromJson(Map<String, dynamic> json) => SellBooking(
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    product: SellProduct.fromJson(json["product"]),
  );
