...
//
//     final returnStatus = returnStatusFromJson(jsonString);

import 'dart:convert';

ReturnStatus returnStatusFromJson(String str) => ReturnStatus.fromJson(json.decode(str));

String returnStatusToJson(ReturnStatus data) => json.encode(data.toJson());
...
class ReturnStatus {
  ...
  factory ReturnStatus.fromJson(Map<String, dynamic> json) => ReturnStatus(
    returnData: List<ReturnDatum>.from(json["data"].map((x) => ReturnDatum.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "data": List<dynamic>.from(returnData!.map((x) => x.toJson())),
  };
}
...
class ReturnDatum {
  ...
  Owner? owner;
  Product? product;
  List<ReturnCondition>? returnCondition;
  ...
  factory ReturnDatum.fromJson(Map<String, dynamic> json) => ReturnDatum(
    ...
    returnCondition: List<ReturnCondition>.from(json["return_condition"].map((x) => ReturnCondition.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "return_condition": List<dynamic>.from(returnCondition!.map((x) => x.toJson())),
  };
}
...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
    ...
    media: List<ReturnCondition>.from(json["media"].map((x) => ReturnCondition.fromJson(x))),
  );
...
class ReturnCondition {
  ...
  factory ReturnCondition.fromJson(Map<String, dynamic> json) => ReturnCondition(
    id: json["id"],
