...
class DisputeDetails extends StatefulWidget {
  static const String route = "DisputeDetails";
  ReturnDatum product;
  AdsObj? adsObj;
  DisputeDetails({required this.product});
  @override
  _DisputeDetailsState createState() => _DisputeDetailsState();
}
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Spacer(),
                                  Text("Pending",style: TextStyle(fontFamily: Const.aventa ,fontSize: 21.sp , fontWeight: FontWeight.w800),),
                                ],
                              ),
                              ...
                              Text("Reason" , style: TextStyle(fontFamily: Const.aventa ,fontSize: 21.sp , fontWeight: FontWeight.w800) ,),
                              SizedBox(height: 3.5.h,),
